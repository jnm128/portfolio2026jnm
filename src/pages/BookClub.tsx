        ...
        <div className="container mx-auto px-6 md:px-10 max-w-[1600px]">
          <FadeIn>
            <div className="flex items-start gap-8 md:gap-12">
              ...
              <div className="hidden md:flex items-start shrink-0 pt-2">
                <div className="w-44 h-56 rounded-xl overflow-hidden shadow-md -rotate-2">
                  <img 
                    src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400&h=520&fit=crop" 
                    alt="Book collection" 
