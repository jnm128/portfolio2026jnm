          ...
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="px-8 py-3 bg-surface-1 text-surface-6 font-medium rounded-full transition-all hover:bg-surface-1/90 hover:scale-105">
                  Join the Community
                </button>
                <button className="px-8 py-3 bg-transparent text-surface-1 font-medium rounded-full border border-surface-1/30 transition-all hover:bg-surface-1/10">
                  Learn More
                </button>
              </div>
            </div>
