                ...
                <div>
                  ...
                  <div className="border-t border-background/15 py-10">
                    <a href="https://www.linkedin.com/in/joannaminott" target="_blank" rel="noopener noreferrer" className="group flex flex-col md:flex-row gap-6 items-start">
                      <div className="w-full md:w-96 shrink-0 rounded-lg overflow-hidden aspect-[16/10] ring-2 ring-background/60">
                        <img
                          src={speakingMiami}
                ...
                <div className="py-10">
                  ...
                  <div className="mt-8 pt-8 border-t border-background/15">
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                      <div className="w-20 md:w-24 shrink-0 rounded-lg overflow-hidden ring-2 ring-background/60">
                        <img
              ...
              <FadeIn delay={400}>
                <div className="py-10">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 shrink-0 rounded overflow-hidden ring-2 ring-background/60">
                      <img
