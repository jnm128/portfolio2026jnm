          ...
          <FadeIn>
              ...
              <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-start">
                ...
                <div className="flex flex-col justify-center md:col-span-2">
                  ...
                  <p className="text-base md:text-lg font-serif leading-relaxed mb-6 text-foreground">
                      ...
                      >
                        <div className="flex items-baseline gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-serif mt-1 leading-relaxed text-foreground">{skill.text}</p>
                          </div>
                        </div>
                      </li>
                    );
