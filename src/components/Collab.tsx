...
const Pill: React.FC<{ text: string; author: string; floatClass?: string; floatDelay?: string }> = ({
  ...
  <div
    className={cn(
      'rounded-full bg-background/5 backdrop-blur-md ring-1 ring-background/40 px-4 py-2 text-xs sm:text-sm text-background/85 font-sans max-w-[260px] sm:max-w-[280px]',
      floatClass
    )}
