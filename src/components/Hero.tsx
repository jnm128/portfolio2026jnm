    ...
    <section className={cn('pt-32 md:pt-40 pb-6 md:pb-8 bg-hero-gradient', className)}>
      <div className="mx-auto max-w-[1600px] px-5 md:px-16">
        <FadeIn>
          ...
          <h1 className="text-3xl md:text-5xl font-serif text-title mb-2">Joanna Minott, <span className="text-muted-foreground italic" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>UX Designer</span></h1>
          <p
            key={audience}
