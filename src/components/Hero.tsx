...
const Hero: React.FC<HeroProps> = ({ className }) => {
  ...
  return (
    <section className={cn('pt-20 md:pt-24 pb-6 md:pb-8 bg-[#F8F6F1]', className)}>
      <div ref={containerRef} className="<div ref={containerRef} className="mx-auto max-w-[1600px] px-8 md:px-16">={containerRef} className="mx-auto max-w-[1600px] px-8 md:px-16"> px-8 md:px-16">
