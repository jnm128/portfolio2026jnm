...
const Community: React.FC<CommunityProps> = ({ className }) => {
  return (
    <section id="community" className={cn('py-16 md:py-24 bg-surface-6 text-surface-1 relative z-[1]', className)}>
        ...
        <FadeIn delay={100}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <Link 
                to="/book-club"
                className="inline-flex items-center justify-center px-5 py-2 bg-surface-1 text-surface-6 text-sm font-medium rounded-full transition-all hover:bg-surface-1/90 active:scale-95"
              >
                Learn More
              </Link>
            </div>
