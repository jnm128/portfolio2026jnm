        ...
        <FadeIn delay={100}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <Link 
                to="/book-club"
                className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 bg-surface-1 text-surface-6 text-sm font-medium rounded-full transition-colors hover:bg-surface-1/90"
              >
                Learn More
              </Link>
            </div>
